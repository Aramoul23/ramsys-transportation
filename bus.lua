...
function setup()
  return {
    ...
    vehicle_height = 3.2, -- in meters, 3.2m is the height of a standard bus
    vehicle_width = 2.5, -- in meters, 2.5m is the width of a standard bus

    -- Size of the vehicle, to be limited mostly by legal restriction of the way
    vehicle_length = 10.0, -- in meters, 10.0m is the length of a bus
